...
# to the already running storescp (see incoming-short.bash).
#
# Call the script with the 0020,000e Series Instance UID as argument, e.g.
#   ./movescu-short.bash 1.2.34.5.6789.0.1.2.34567.89012345678901234567890123456
#
...
${movescu} \
  ...
  --move ${calling_aetitle_short} \
  --key "0008,0052=SERIES" \
  --key "0020,000e=${seriesUID}" \
  ${movescu_peer} ${movescu_port} 1>>"$incomingDir/movescu-short.log" 2>&1
