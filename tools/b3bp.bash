...
# Usage:
#
#  LOG_LEVEL=7 ./b3bp.bash -f /tmp/x -d (change this for your script)
#
...
LOG_LEVEL="${LOG_LEVEL:-3}" # 4 = debug -> 0 = error
...
function error ()     {                                  __b3bp_log error "${@}"; exit 1; }
function warning ()   { [[ "${LOG_LEVEL:-0}" -ge 1 ]] && __b3bp_log warning "${@}"; true; }
function notice ()    { [[ "${LOG_LEVEL:-0}" -ge 2 ]] && __b3bp_log notice "${@}"; true; }
function info ()      { [[ "${LOG_LEVEL:-0}" -ge 3 ]] && __b3bp_log info "${@}"; true; }
function debug ()     { [[ "${LOG_LEVEL:-0}" -ge 4 ]] && __b3bp_log debug "${@}"; true; }
